namespace Dentas_Pro.UI.User
{
    ...
    /// </summary>
    public partial class Annual_Permit_List_Form : Base_Form
    {
        public Annual_Permit_List_Form()
        {
            InitializeComponent();
        ...
        public void List_The_Annual_Permit_For_Permit_Type()
        {
            ...
            #region Old_Code
            ///*Satış direktörü ise bütün satışı görür*/
            //if (Login_Form.Login_User_Obj_Id == 110)
            //{
            ...
            //               /*Where clause'unda satış bölgelerini filtrleiyoruz*/
            //               where d.Obj_Id == 24 || d.Obj_Id == 1 || d.Obj_Id == 2 || d.Obj_Id == 3 || d.Obj_Id == 4 || d.Obj_Id == 5 || d.Obj_Id == 6 || d.Obj_Id == 7 || d.Obj_Id == 8
            //               select new
            //               {
            //                   Sıra = ap.Obj_Id,
            ...
            ///*Üretim direktörü  (Evren) - oluklu için bütün üretimi görür*/
            //if (Login_Form.Login_User_Obj_Id == 34)
            //{
            //    var list = from ap in sql_Server_Db_From_Follow_Up_Data_Context.Annual_Permits
            ...
            //               /*join pr in sql_Server_Db_From_Follow_Up_Data_Context.Permit_Reasons on ap.Permit_Reason_Obj_Id equals pr.Obj_Id*/
            //               orderby ap.Permit_Start_Time descending
            //               /*Where clause'unda oluklu fabrikalrını filtreliyoruz*/
            //               where d.Obj_Id == 9 || d.Obj_Id == 12 || d.Obj_Id == 14 || d.Obj_Id == 22
            //               select new
            //               {
            //                   Sıra = ap.Obj_Id,
            //                   Ad_Soyad = u.Full_Name,
            ...
            // * Bayram, İrfan, Tekin
            // */
            //if (Login_Form.Login_User_Obj_Id == 2 || Login_Form.Login_User_Obj_Id == 1 || Login_Form.Login_User_Obj_Id == 69)
            //{
            //    var list = from ap in sql_Server_Db_From_Follow_Up_Data_Context.Annual_Permits
            ...
            // * Velişah
            // */
            //if (Login_Form.Login_User_Obj_Id == 46 )
            //{
            //    var list = from ap in sql_Server_Db_From_Follow_Up_Data_Context.Annual_Permits
            ...
            //               orderby ap.Permit_Start_Time descending
            //               /*Where clause'unda bilgi işlem'i filtreliyoruz*/
            //               where d.Obj_Id == 11 || d.Obj_Id == 13 || d.Obj_Id == 18
            //               select new
            //               {
            //                   Sıra = ap.Obj_Id,
            //                   Ad_Soyad = u.Full_Name,
            ...
            ///*İç denetim*/
            //if (Login_Form.Login_User_Obj_Id == 48)
            //{
            //    var list = from ap in sql_Server_Db_From_Follow_Up_Data_Context.Annual_Permits
            ...
            if (annual_Permit_Form.Job_Title_TextEdit.Text.Contains("Müdür") == true)
            {
                var list = from ap in sql_Server_Db_From_Follow_Up_Data_Context.Annual_Permits
                           ...
                           /*Where clause'unda bilgi işlem'i filtreliyoruz*/
                           where u.Department_Obj_Id == annual_Permit_Form.Department_Obj_Id && ap.Approval_Department_Manager_Situation == false || ap.Approval_Department_Manager_Situation == null
                           select new
                           {
                               Sıra = ap.Obj_Id,
                               Ad_Soyad = u.Full_Name,
            ...
            if (annual_Permit_Form.Job_Title_TextEdit.Text.Contains("Yönetmen") == true)
            {
                var list = from ap in sql_Server_Db_From_Follow_Up_Data_Context.Annual_Permits
            ...
            /*Düz personel*/
            if (annual_Permit_Form.Job_Title_TextEdit.Text.Contains("Müdür") == false && annual_Permit_Form.Job_Title_TextEdit.Text.Contains("Yönetmen") == false && annual_Permit_Form.Job_Title_TextEdit.Text.Contains("Direktör") == false)
            {
                var list = from ap in sql_Server_Db_From_Follow_Up_Data_Context.Annual_Permits
