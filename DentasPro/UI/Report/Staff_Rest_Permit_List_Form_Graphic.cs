namespace Dentas_Pro.UI.Report
{
    ...
    public partial class Staff_Rest_Permit_List_Form_Graphic : Base_Form
    {
        /// <summary>
        /// Departman kalan izin Listesi
        /// </summary>
        public Staff_Rest_Permit_List_Form_Graphic()
        {
            InitializeComponent();
            Grouped_Column_Summary();
        ...
        public void Grouped_Column_Summary() 
        {
